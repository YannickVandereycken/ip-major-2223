defmodule StudentWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StudentWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StudentWeb.Gettext, "errors", msg, opts)
    end
  end
